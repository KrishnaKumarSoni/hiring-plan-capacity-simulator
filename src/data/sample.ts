...
export const SAMPLE_TEXT = `Hire 12 backend engineers by Dec 15 across three reqs: Platform (5), Infra (3), and Payments (4, sourcing can start mid-October).
...
Recruiter screen to HM conversion is 60%; System Design to Behavioral is 70%.`;
...
function sampleRoster(): Interviewer[] {
  ...
  return [
    // Recruiting team
    iv("rec1", "Nora Whitfield", ["recruiter"], 8, { 6: 1 }),
    iv("rec2", "Tomas Rivera", ["recruiter"], 8, {}, [12]),
    iv("rec3", "Elena Rodrigues", ["recruiter"], 8, { 2: 1 }),
    // Hiring managers
    iv("hm1", "Marcus Webb", ["hm"], 7, { 3: 1, 8: 1 }),
    iv("hm2", "Claire Fontaine", ["hm"], 7, { 5: 1 }),
    ...
    iv("be5", "Anna Lindqvist", ["backend"], 3, { 6: 0.5 }),
    ...
    iv("ov1", "Sofia Marchetti", ["backend", "sysdesign", "staffplus"], 3, { 1: 1, 3: 0.5, 5: 1, 7: 0.5, 10: 0.5, 11: 0.5, 12: 0.5, 13: 1, 14: 1 }, [15]),
    iv("ov2", "Lucas Weber", ["sysdesign", "staffplus"], 3, { 2: 1, 4: 0.5, 8: 1, 11: 0.5, 12: 0.5, 14: 1 }, [13]),
    iv("ov3", "Maya Chen", ["backend", "sysdesign", "staffplus"], 3, { 0: 1, 6: 0.5, 10: 1, 11: 0.5, 13: 1, 14: 1 }, [12]),
    iv("ov4", "Emma Kowalski", ["sysdesign", "staffplus"], 3, { 3: 1, 9: 0.5, 11: 0.5, 12: 0.5, 13: 1 }, [14]),
    iv("ov5", "Yuki Tanaka", ["sysdesign", "staffplus"], 3, { 5: 0.5, 10: 0.5 }, [14]),
    // Staff+ only
